...
$SupportLogsPath = Read-Host "Enter the file path of the Support Files without the trailing '\' `n For Example: C:\Cases\1234567\SupportFiles `r`n"
$MPRegistry = $SupportLogsPath + '\MPRegistry.txt'

$ResultList = [System.Collections.ArrayList](Get-Content $MPRegistry | Select-String '7674ba52-37eb-4a4f-a9a1-f0f9a1619a2c', '56a863a9-875e-4185-98a7-b882c64b5ce5', 'd4f940ab-401b-4efc-aadc-ad5f3c50688a', 
...
'b2b3f03d-6a65-4f7b-a9c7-1c7ef74a9ba4', '92e97fa1-2edf-4476-bdd6-9dd0b4dddc7b', 'c1db55ab-c21a-4637-bb3f-a12568109d35')

ForEach ($Item in $ResultList){
If ($Item.ToString() -Like '*(0X2)*'){
...
Elseif ($ResultList = $null){
Write-Host "No Attack Surface Reduction Rules were found. For more information about ASR Rules, please visit: `r`n https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/overview-attack-surface-reduction?view=o365-worldwide "
}
}
