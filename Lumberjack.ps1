...
$MPRegistryResults = [System.Collections.ArrayList](Get-Content $MPRegistry | Select-String 'DisableAntiVirus', 'DisableAntiSpyware','IsServiceRunning', ' PassiveMode ', 'PUAProtection',
'SenseOrgId', 'TamperProtection ', 'ASSignatureVersion', 'AVSignatureVersion', 'EngineVersion', ' InstallLocation', 'Current configuration options for location "system policy"')
...
Write-Host $i}
    ...
    Write-Host "`r`n 2: Press '2' General config info"
    Write-Host "`r`n 3: Press '3' Event logs"
    Write-Host "`r`n 4: Press '4' Definition of logs"
    Write-Host "`r`n 5: Press '5' Exclusions"
    Write-Host "`r`n 6: Press '6' View other log set"
